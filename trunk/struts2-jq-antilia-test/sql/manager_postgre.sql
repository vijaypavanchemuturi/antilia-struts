...
CREATE TABLE COUNTRY (
  id INTEGER NOT NULL PRIMARY KEY DEFAULT nextval('COUNTRY_SEQ'),
...
CREATE TABLE CITY (
  id INTEGER NOT NULL PRIMARY KEY DEFAULT nextval('CITY_SEQ'),
...
CREATE TABLE ADDRESS (
  id INTEGER NOT NULL PRIMARY KEY DEFAULT nextval('ADDRESS_SEQ'),
...
CREATE TABLE EMPLOYEE (
  id INTEGER NOT NULL PRIMARY KEY DEFAULT nextval('EMPLOYEE_SEQ'),
...
CREATE TABLE ROLE (
  id INTEGER NOT NULL PRIMARY KEY DEFAULT nextval('ROLE_SEQ'),
  name VARCHAR(100) NOT NULL,
...
CREATE TABLE PROJECT (
  id INTEGER NOT NULL PRIMARY KEY DEFAULT nextval('PROJECT_SEQ'),
...
CREATE SEQUENCE CHARGERATE_SEQ;

CREATE TABLE CHARGERATE (
    id INTEGER NOT NULL PRIMARY KEY DEFAULT nextval('CHARGERATE_SEQ'),
    customer INTEGER NOT NULL,
    role INTEGER NOT NULL, 
...
CREATE TABLE TASK (
  id INTEGER NOT NULL PRIMARY KEY DEFAULT nextval('TASK_SEQ'),
...
CREATE SEQUENCE ASIGNMENT_SEQ;

CREATE TABLE ASIGNMENT (
  id INTEGER NOT NULL PRIMARY KEY DEFAULT nextval('ASIGNMENT_SEQ'),
