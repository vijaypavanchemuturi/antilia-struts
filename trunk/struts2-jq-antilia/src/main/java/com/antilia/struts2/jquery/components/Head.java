...
public class Head extends org.apache.struts2.components.Head {
  ...
  public void evaluateParams()
  {
    ...
    if (this.jqgrid != null) addParameter("jqgrid", findValue(this.jqgrid, Boolean.class));
  ...
  {
    return jqgrid != null && Boolean.parseBoolean(jqgrid);
  }

  @StrutsTagAttribute(description = "enable jggrid Scripts", defaultValue = "false", type = "Boolean")
